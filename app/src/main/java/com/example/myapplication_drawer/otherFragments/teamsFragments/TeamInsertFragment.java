 ...
 * Use the {@link TeamInsertFragment#newInstance} factory method to
...
public class TeamInsertFragment extends Fragment {
     ...
     * @return A new instance of fragment TeamMenuFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TeamInsertFragment newInstance(String param1, String param2) {
        TeamInsertFragment fragment = new TeamInsertFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_team_insert, container, false);
        submit = root.findViewById(R.id.team_insert_submit);
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(insertToDBTeam(root)){
                    Toast.makeText(root.getContext(),"Η ομάδα καταχωρήθηκε.",Toast.LENGTH_LONG).show();
                }else{
    ...
    public boolean insertToDBTeam(View root){
        EditText txt1 = root.findViewById(R.id.team_insert_id_txt);
        EditText txt2 = root.findViewById(R.id.team_insert_name_txt);
        EditText txt3 = root.findViewById(R.id.team_insert_fieldname_txt);
        EditText txt4 = root.findViewById(R.id.team_insert_town_txt);
        EditText txt5 = root.findViewById(R.id.team_insert_country_txt);
        EditText txt6 = root.findViewById(R.id.team_insert_sport_id_txt);
        EditText txt7 = root.findViewById(R.id.team_insert_etos_txt);
        try{
            if(txt1.getText() != null && txt2.getText() != null && txt3.getText() != null && txt4.getText() != null && txt5.getText() != null && txt6.getText() != null && txt7.getText() != null ){
                ...
                MainActivity.myDB.mydao().insertTeam(team);
            }else{return false;}
            txt1.setText(null);
            txt2.setText(null);
            txt3.setText(null);
...
//
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getActivity().getApplicationContext(), MainActivity.id)
                ...
                .setContentText("Σφάλμα Εισαγωγής Ομάδας!")
